...
## Self-Guided Summer Methods Program {#top}
...
s. $y = (3x^2 + 4)(2x^3 + 3x + 5)$. The derivative is $30x^4 + 51x^2 + 30x + 12$
...
y. $y = \frac{x^3 + x^2 + x + 1}{x^2 + x +1}$. The derivative is $\frac{x^2(x^2 + 2x + 3)}{(x^2 + x + 1)^2}$
...
c. $f(x) = \frac{x^2-4}{x^5 - x^3 + x}$. The derivative is $-\frac{3x^6 - 21x^4 + 11x^2 -4}{x^2(x^4 -x^2 +1)^2}$

e. $xg(x) - 7x^2$ where $g(x) = e^xln(x)$. The derivative is $e^xln(x) + \frac{e^x}{x} - 14x$

g. $f(x) = e^{5x}$. The derivative is $5e^{5x}$. 

i. $f(x) = \frac{1}{2}e^{\frac{x}{2}}$. The derivative is $\frac{e^{\frac{x}{2}}}{4}$

k. $f(x) = e^{ln(2x)}$. The derivative is $2$. $e^{ln(2x)} = 2x$ by definition. 

m. $f(x) = x^2g(x) + 6x^2$ where $g(x) = log_a(x) + x^7$. The derivative is $\frac{2x ln(x)}{ln(a)} +7x^6 + \frac{x}{ln(a)} + 12x$
